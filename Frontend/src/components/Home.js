                        ...
                        <div className="col-md-4">
                            <div className="card h-100 shadow-sm">
                                <div className="card-body text-center">
                                    ...
                                    <a href="/Nosotros"><img width="80" height="80" src="https://img.icons8.com/fluency/48/info.png" alt="Nosotros" /></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-4">
                            <div className="card h-100 shadow-sm">
                                <div className="card-body text-center">
                                    ...
                                    <p className="card-text">Busqueda por Establecimientos Educacionales</p>
                                    <a href="/Establecimientos"><img width="80" height="80" src="https://img.icons8.com/color/48/classroom.png" alt="Establecimientos" /></a>
                                </div>
                            </div>
                        </div>
