...
function ClientsLogin() {
    ...
    const { userLogin } = useAuth(); // Asegúrate de que este hook esté definido y sea el correcto en tu contexto
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            userLogin(token); // Asegúrate de que userLogin esté definido correctamente y actualice el estado de autenticación
            navigate('/Cliente'); // Redirige al usuario a la página de inicio del cliente
        } catch (err) {
            console.error(err);
